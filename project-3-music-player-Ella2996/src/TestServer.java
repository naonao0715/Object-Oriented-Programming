...
public class TestServer {
    ...
    public static void main(String[] args) throws Exception {
        ...
        handler.addServletWithMapping(new ServletHolder(new artistSearchServlet()), "/artist");
        handler.addServletWithMapping(new ServletHolder(new albumSearchServlet()), "/album");
